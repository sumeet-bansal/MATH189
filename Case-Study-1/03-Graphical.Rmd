...
hist(data.smoker$bwt,
     main = "Histogram of the Birth Weight of Smoking Mothers' Babies",
     xlab = "Birth Weight of Smoking Mothers' Babies (ounces)",
     border = "white",
     col = "dark red",
     las = 1,
     breaks = 25)
...
hist(data.nonsmoker$bwt,
     main = "Histogram of the Birth Weight of Non-Smoking Mothers' Babies",
     xlab = "Birth Weight of Non-Smoking Mothers' Babies (ounces)",
     border = "white",
     col = "dark green",
     las = 1,
     breaks = 25)
...
boxplot(data.smoker$bwt,
        data.nonsmoker$bwt,
        main = "Boxplots of Birth Weight of Smoking & Non-Smoking Mothers' Babies",
        names = c("Smoking Mothers", "Non-Smoking Mothers"),
        ylab = "Birth Weight of Babies (ounces)",
...
qqplot(data.smoker$bwt,
       data.nonsmoker$bwt,
       main = "Q-Q Plot of the Birth Weight of Babies of Smokers vs. Non-Smokers",
       xlab = "Smoking Mothers' Babies",
       ylab = "Non-Smoking Mothers' Babies")
abline(c(0,1))
```
...
qqnorm(data.smoker$bwt,
       main = "Normal Quantile Plot of the Birth Weight of Smokers' Babies",
       col = "dark red")
qqline(data.smoker$bwt,
       col = "dark red")

qqnorm(data.nonsmoker$bwt,
       main = "Normal Quantile Plot of the Birth Weight of Non-Smokers' Babies",
       col = "dark green")
