...
length(smokers$bwt)
length(smokers$bwt[smokers$bwt < lowbwt]) / length(smokers$bwt)
```
...
length(nonsmokers$bwt[nonsmokers$bwt < lowbwt]) / length(nonsmokers$bwt)
```
...
plot(weights, freqs, type='l', main="Frequencies of Low Birth Weight for Babies Born to Smokers", xlab="Threshold for Low Birth Weight", ylab="Frequency for Threshold")
remove(i)
```
...
plot(weights[1:length(weights)-1], deltas, type='p', main="Deltas of Frequencies of Low Birth Weights for Babies Born to Smokers", xlab="Threshold for Low Birth Weight", ylab="Delta of Frequencies for Consecutive Birth Weights")
remove(i)
```
...
plot(weights, freqs, type='l', main="Frequencies of Low Birth Weight for Babies born to Non-Smokers", xlab="Threshold for Low Birth Weight", ylab="Frequency for Threshold")
remove(i)
```
...
deltas <- c()
for (i in 1:length(weights)-1) { deltas[i] <- freqs[i+1] - freqs[i] }
plot(weights[1:length(weights)-1], deltas, type='p', main="Deltas of Frequencies of Low Birth Weights for Babies Born to Non-Smokers", xlab="Threshold for Low Birth Weight", ylab="Delta of Frequencies for Consecutive Birth Weights")
remove(i)
```
